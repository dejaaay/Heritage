            ...
            <tbody>
                ...
                if ($result_fetch && mysqli_num_rows($result_fetch) > 0) {
                    ...
                    foreach ($appointment as $apptmnt) {
                        ...
                        echo '<button class="delete-button btn btn-danger m-2 text-light btnArchive" onclick="showConfirmationModal(' . htmlspecialchars($apptmnt['appointment_id']) . ')">Delete</button>';
                        echo '</td>';
